...
import { PMHEvent } from '../types';

const Events: React.FC = () => {
  const [events, setEvents] = useState<PMHEvent[]>([]);
    ...
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn>
            ...
            <p className="text-xl text-gray-400 max-w-2xl">
              Witness our recent activities across Nigeria, now updated directly via CMS.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            <div className="text-center py-20 font-bold text-punchline-gray">Fetching Gallery...</div>
          ) : (
                  ...
                  <div className="bg-punchline-light p-8 rounded-[2rem] border border-gray-100 h-full hover:shadow-xl transition-all flex flex-col">
                    ...
                    <div className="space-y-3 text-punchline-gray">
                      <div className="flex items-center text-sm font-medium">
                        <Calendar size={18} className="mr-3 text-punchline-blue" /> {new Date(event.date).toLocaleDateString()}
                      </div>
                      <div className="flex items-center text-sm font-medium">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeIn direction="right">
              <div className="space-y-8">
                <h2 className="text-4xl font-black font-heading text-punchline-black">Corporate Training</h2>
                <p className="text-lg text-punchline-gray leading-relaxed">
                  Bespoke programs for Nigerian organizations. Updated instantly when new partnerships arise.
                </p>
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 w-fit">
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Active Partnerships</p>
                </div>
            ...
            <FadeIn direction="left" delay={0.2}>
              <img src="https://picsum.photos/seed/corp/1000/1000" className="rounded-[3rem] shadow-2xl" alt="Corporate" />
            </FadeIn>
          </div>
        </div>
      </section>
